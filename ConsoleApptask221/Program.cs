...
namespace ConsoleApptask221
{
    class Program
    {
        ...
        {
            Player player = new Player(100, 0, 0, 1); //имя, здоровье, положение на Х и на У
            ...
            while ((player.HealthLine > 0))
            {
                ...
                if ((bonus.PositionX == player.PositionX) && (bonus.PositionY == player.PositionY))
                {
                    ...
                    Console.WriteLine("BONUS: + 150 health, your health: " + player.HealthLine);
                }
                ...
                if ((serum.PositionX == player.PositionX) && (serum.PositionY == player.PositionY))
                {
                    ...
                    Console.WriteLine("BONUS: + 1 speed, your speed: " + player.speedNow);
                }
                ...
                if ((tree.PositionX == player.PositionX) && (tree.PositionY == player.PositionY))
                {
                    player.MoveToX(-1);
                    player.MoveToY(-1);
                    Console.WriteLine("TREE: your position: " + player.PositionX + "," + player.PositionY);
                }
                ...
                if ((stone.PositionX == player.PositionX) && (stone.PositionY == player.PositionY))
                {
                    player.MoveToX(2);
                    player.MoveToY(2);
                    Console.WriteLine("STONE: your position: " + player.PositionX + "," + player.PositionY);
                }
